...
class Application(tk.Frame):
    ...
    def create_order_screen(self):
        ...
        pieces = [piece for sublist1 in nested_list for sublist2 in sublist1 for piece in sublist2]
    ...
    def delete_order(self):
        ...
        order_combobox = ttk.Combobox(delete_order_window, values= orders_ID)
