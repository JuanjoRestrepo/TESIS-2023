...
class InspectionModule():
    ...
    def lines(self,image,h1,g1,h2,g2,h3,g3,h4,g4):
        ...
        cv2.line(image,(100,0),(100,HighP),(int(r),int(g),int(b)),int(300))
        cv2.line(image,(550,0),(550,HighP),(int(r),int(g),int(b)),int(300))
        return image
...
m2, m3, img = cep.measurePic(m1=22,fm2=0.9,fm3=1,h1=1,g1=0.5,h2=0.67,g2=0.07,h3=0.4,g3=0.07,h4=0.06,g4=0.07)
print(m2,m3)
