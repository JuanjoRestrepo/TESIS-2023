...
Programa de funciones del robot ( abrir, moverse, etc)
"""
...
# Se define la clase tipo ejecucion

class execute: #objeto robot para ejecutar comandos directamente
    ...
    def txl (self, a):
        #codificar cadena de string y mandar a funcion text
        r = len(a)
        for i in range(r):
            if i == 0:
                data = a[i] + " "
...
class program: #objeto robot para escribir lineas de comandos
